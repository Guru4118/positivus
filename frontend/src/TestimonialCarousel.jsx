  ...
  return (
    <div>
         <div className='flex mx-30 mb-10'>
                ...
                <div>
                    <p style={{ backgroundColor: "rgb(185,255,102)" }} className='px-5 py-2 rounded-xl font-bold text-xl'>Testimonials</p>
                </div>
                <div className='ml-20'>
    ...
    <div className="bg-[#1c1c24] text-white py-12 px-20 rounded-2xl  mx-30 mb-10 relative">
      <div className="flex items-center justify-between">
        ...
        {/* Testimonial Card */}
        <div className="relative w-full max-w-2xl mx-4 border  rounded-xl px-6 py-8" style={{ border: "rgb(185,255,102)" }}  >
          <p className="text-gray-200 mb-4">"{testimonials[current].quote}"</p>
          <p  className="text-white font-bold mt-6">{testimonials[current].name}</p>
